...
+ (BOOL) isValidNumber:(NSString*)value{
    ...
    NSString *_value = [value stringByReplacingOccurrencesOfString:@"." withString:@""];
    const char *cvalue = [_value UTF8String];
    int len = strlen(cvalue);
    for (int i = 0; i < len; i++) {
...
+ (BOOL) isValid:(IdentifierType) type value:(NSString*) value
{
    ...
    switch (type)
    {
        case IdentifierTypeZipCode:
            result = [self isValidZipcode:value];
            break;
        ...
        case IdentifierTypeUnicomPhone:
            result = [self isChinaUnicomPhoneNumber:value];
            break;
        ...
        case IdentifierTypeString:
            result = [self isValidString:value];
            break;
        case IdentifierTypeIdentifier:
            result = [self isValidIdentifier:value];
            break;
        case IdentifierTypePassort:
            result = [self isValidPassport:value];
            break;
        case IdentifierTypeCreditNumber:
            result = [self isValidCreditNumber:value];
            break;
        case IdentifierTypeBirthday:
            result = [self isValidBirthday:value];
            break;
        default:
            break;
    }
