...
@interface LCTabBarController () <LCTabBarDelegate,UITabBarControllerDelegate>
...
- (void)tabBar:(LCTabBar *)tabBarView didSelectedItemFrom:(NSInteger)from to:(NSInteger)to {
    ...
    if(self.lcDelegate){
        [self.lcDelegate didSelectViewController:[(UINavigationController *)self.viewControllers[self.selectedIndex] viewControllers][0]];
    }
}
